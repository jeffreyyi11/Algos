...
function floodFill(canvas2D, startXY, newColor) {
    ...
    let xpos = startXY[0]
    let ypos = startXY[1]
    let startval = canvas2D[xpos, ypos]
    //change starting position value to new value 
    canvas2D[startval] = newColor
    //find left positions and if same value change to new value
    //find right positions and if same value change to new value
    //find upper positions and if same value change to new value
    //find lower positions and if same value change to new value
}